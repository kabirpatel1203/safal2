...
/> */}
            ...
            <div className={Styles.personalDetails}>
                ...
                <div className={Styles.personalDetails1}>
                    ...
                    <input className={Styles.inputTag} onChange={(e) => { formHandler(e) }} defaultValue={formData.name} value={formData.name} name="name" placeholder='Mistry Name' disabled={user.role !== "admin"} />

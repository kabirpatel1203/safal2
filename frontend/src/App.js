...
import Builder from './component/Pages/Builder/Builder';
  ...
  return (
    <>
      <Routes>
        ...
        <Route exact path='/builder' element={(loading === false && isAuthenticated === true) ? <Builder /> : <SignIn />} />
        ...
        <Route exact path='/graphs' element={(loading === false && isAuthenticated && user?.role === "admin") ? <Graphs /> : <SignIn />} />

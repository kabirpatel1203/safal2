...
const { createDealer, getDealer, updateDealer, deleteDealer, getAllDealer, totalDealer, changeDealerSalesPerson } = require("../controllers/dealerController");
...
router.route("/change-salesperson").put(isAuthenticatedUser, authorizeRoles("admin"), changeDealerSalesPerson);

...
const { createbranch,
    ...
    getMistryofBranch,
    getDealersofBranch,
    getInquiriesofBranch,
    getSalesmenofBranch} = require("../controllers/branchController");
...
router.route("/inquiry").post(isAuthenticatedUser,getInquiriesofBranch);
router.route("/salesmen").post(isAuthenticatedUser,getSalesmenofBranch);

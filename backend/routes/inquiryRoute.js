...
const { createInquiry, getInquiry, updateInquiry, deleteInquiry, getAllInquiry, totalInquiry ,getFilteredInquiry, migrateInquiries} = require("../controllers/inquiryController");
